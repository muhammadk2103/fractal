window.addEventListener('load', function(){
  ...
  const maxLevel = 5; // determines depth of the fractal
  const branches = 2;
  
  let sides = 5; // quantity of the segments's lines
  let scale = 0.7; // how much smaller are the segments compare to their parents
  let spread = 0.6; // angle in radians between parent branches and the segments
